...
\begin{question}
  Is the product of a negligible function and a non-negligible function necessarily negligible, necessarily non-negligible, or not necessarily either?
\end{question}
  
\begin{answer}
  Not necessarily either; it depends on the functions. Consider \(f(n) = 2^{-n}\)
